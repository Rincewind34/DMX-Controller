...
public class RGBFader extends HBox implements TemplateComponent {
	...
	public RGBFader() {
		TemplateComponent.loadFXML(this, "rgb-fader.fxml", "basics.css", "colorfader.css");
		...
		this.color1 = new double[3];
		this.color2 = new double[3];
		this.color3 = new double[3];
